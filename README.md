# 💫 About Me:
:office: Mid-Level BackEnd Developer at City Connect<br>:scroll: Deep diving into Go.<br>:seedling: Learning Software Architecture and Rust to write lambda functions.<br>:joystick: I read, lift, write and cook.
